...
try:
    api_id = int(os.environ["2836609"])
    api_hash = os.environ["2abaa90ca376c9f6861858eb380fa134"]
    bot_token = os.environ["5140967930:AAE0glrudrZAX9a_Xx8e-D8Y6KQE6tGfdpY"]
    from_channel = int(os.environ["-1001781627489"])
    to_channel = int(os.environ["-1001709231070"])
